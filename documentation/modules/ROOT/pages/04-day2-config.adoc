...
Go to https://github.com/WorkshopGitOpsInfra/helm-infra-gitops-workshop[helm-infra-gitops-workshop] repository and checkout to your working branch.
...
Go to your working branch in the https://github.com/WorkshopGitOpsInfra/helm-infra-gitops-workshop[helm-infra-gitops-workshop] repository and create a file called *values-oauth.yaml*:
...
Go to your working branch in the https://github.com/WorkshopGitOpsInfra/helm-infra-gitops-workshop[helm-infra-gitops-workshop] repository and create a file called *values-operators.yaml*:
...
Go to your working branch in the https://github.com/WorkshopGitOpsInfra/helm-infra-gitops-workshop[helm-infra-gitops-workshop] repository and create a file called *values-namespace.yaml*:
...
Go to your working branch in the https://github.com/WorkshopGitOpsInfra/helm-infra-gitops-workshop[helm-infra-gitops-workshop] repository and create a file called *values-monitoring.yaml*:
...
In the https://github.com/WorkshopGitOpsInfra/helm-infra-gitops-workshop[helm-infra-gitops-workshop] repository, you can find a _secret_ using a Vault placeholder in _charts/vault/values.yaml_:
...
Checkout to *main-day2* branch in this https://github.com/WorkshopGitOpsInfra/workshop-gitops-content-deploy[workshop-gitops-content-deploy] repository to take a look:
