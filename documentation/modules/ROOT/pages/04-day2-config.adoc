...
Once the _values-oauth.yaml_ exists in your repository, make a push and create a new Application in the _argocd-infra_ instance:
...
Once the _values-operators.yaml_ exists in your repository, make a push and create a new Application in the _argocd-infra_ instance:
...
Once the _values-monitoring.yaml_ exists in your repository, make a push and create a new Application in the _argocd-infra_ instance:
...
Configuring the monitoring application is relatively straightforward since it does not have any direct dependencies on other objects. As such, you do not need to worry about setting up _Sync Waves_, which are typically used to manage the order in which objects are deployed to avoid issues with dependencies.
...
Once the _values-namespace.yaml_ exists in your repository, make a push and create a new Application in the _argocd-infra_ instance:
...
Take a look to the configuration applied by the Application _sno-setup_ on your _SNO_  _argocd-infra_ instance where those resources have been already created as part of _bootstrapping_. Do not make any change.
