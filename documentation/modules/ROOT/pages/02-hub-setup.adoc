...
This is the general overview of the lab. You will be able to connect to both argo-hub and managed clusters, and day 2 operations will setup based on servers running on argo hub.
...
In this cluster you can find two argo instance, openshift-gitops (default) and argocd. Default instance is intended to manage the hub itself, and it is in charge of
