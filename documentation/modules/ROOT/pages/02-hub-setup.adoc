...
----
oc login -u user-<name> -p <pass> <ocp-hub-cluster-api>
----  
...
You can take a look to the chart used for creating these secrets https://github.com/WorkshopGitOpsInfra/workshop-gitops-content-deploy/blob/setup-sno/hub-setup/charts/gitops-setup/values.yaml[here] and https://github.com/WorkshopGitOpsInfra/workshop-gitops-content-deploy/blob/setup-sno/hub-setup/charts/gitops-setup/templates/secret-cluster.yaml[here].
