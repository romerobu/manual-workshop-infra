...
=== *Push changes to your forked repository _/workshop-gitops-content-deploy_*

Finally push your changes to your working branch, then we are going to deploy the _manage-setup-a-<name>_ Application in order to _bootstrap_ the managed cluster, _SNO_ in this case:
