...
Deployment never progess to 5 replicas, and argo stays in Progressing trying to reconcile a not allowd valued of replicas. Finally set it back to 1 replica.
