...
Argo hub setup: https://github.com/romerobu/workshop-gitops-content-deploy.git

Apps deployment charts: https://github.com/romerobu/workshop-gitops-apps-deploy.git

Helm charts: https://github.com/romerobu/helm-infra-gitops-workshop.git