...
:tutorial-url: https://github.com/romerobu/workshop-gitops-content-deploy.git
:tutorial-url: https://github.com/romerobu/workshop-gitops-apps-deploy.git
:tutorial-url: https://github.com/romerobu/helm-infra-gitops-workshop.git