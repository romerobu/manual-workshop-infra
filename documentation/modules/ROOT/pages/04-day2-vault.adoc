    ...
    env:
      - name: HELM_VALUES
        value: >-
          ...
          --set oauth.oauth.keycloak.clientid=myclient-<name>
          --set oauth.oauth.keycloak.issuer=https://keycloak-keycloak.apps.argo-hub.<domain>/realms/myrealm-<name>
          --set oauth.oauth.ldap.sync.ldap_url='ldap://<node_ip>:<nodeport>' 
          --set oauth.oauth.keycloak.data="wAadePAC6nUmTxzp80SrE7hdGM6T3up9"
